...
$manifestParams = @{
    ...
    Tags              =  @("Graph", "Entra", "Toolbox", "Automation")
    LicenseUri        = "https://raw.githubusercontent.com/alflokken/PSGraphToolbox/main/LICENSE.txt"
    ProjectUri        = "https://github.com/alflokken/PSGraphToolbox"
